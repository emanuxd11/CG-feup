...
export class MyRock extends CGFobject {
    ...
    static rockTextures = [
        '../images/rock/rock_sphere_projection_1.jpg',
        '../images/rock/rock_sphere_projection_2.jpg',
        '../images/rock/haumea_sphere_projection.jpg'
    ]
  ...
  initBuffers() {
    ...
    for (let slice = 0; slice<this.slices+1; slice++) {
      for (let stack = 0; stack<2*this.stacks+1; stack++) {
        ...
        if (stack == 0 || stack == 2*this.stacks || slice == 0 || slice == this.slices) {
            this.vertices.push(this.radius*x, this.radius*y, this.radius*z);
        }
        else {
            let rd = (MyRandom.getRandomInt(1, 3) + MyRandom.getRandomInt(1, 3) + MyRandom.getRandomInt(1, 3) + 4)/ 10;
            this.vertices.push(rd*this.radius*x, rd*this.radius*y, rd*this.radius*z);
        }
