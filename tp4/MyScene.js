...
export class MyScene extends CGFscene {
  ...
  init(application) {
    ...
    this.minecraft = new MyUnitCubeQuad(this, this.textureTop, this.textureSide, this.textureSide, this.textureSide, this.textureSide, this.textureBottom);

    // to show/hide
    this.displayQuad = false;
    this.displayTangram = false;
    this.displayMinecraft = true;
  ...
  display() {
    ...
    if (this.displayQuad) {
      ...
      // this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.gl.NEAREST); // this is the code for filtering
    ...
    if (this.displayMinecraft) {
      this.minecraft.display();
    }
  }
}
